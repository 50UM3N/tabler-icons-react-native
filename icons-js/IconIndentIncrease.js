...
function IconIndentIncrease({
  ...
  return <Svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-indent-increase" width={size} height={size} viewBox="0 0 24 24" strokeWidth={stroke} stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round" {...props} ><Path stroke="none" d="M0 0h24v24H0z" fill="none" /><Path d="M20 6l-11 0" /><Path d="M20 12l-7 0" /><Path d="M20 18l-11 0" /><Path d="M4 8l4 4l-4 4" /></Svg>;
